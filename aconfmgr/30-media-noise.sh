...
## noise/music
### console interface
AddPackage haskell-tidal # A domain specific language for live coding pattern.
AddPackage supercollider # Platform for audio synthesis and algorithmic composition
